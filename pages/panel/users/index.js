...
import PeopleOutlineIcon from '@mui/icons-material/PeopleOutline'; // Using outline version for minimalist look
  ...
  return (
    <div className="ml-20 mr-4 p-2 h-screen lg:ml-64 lg:mr-8">
      <div className="flex items-center mb-10 mt-4">
        ...
        <PeopleOutlineIcon className="text-blue-500 mr-3" sx={{ fontSize: 28 }} />
      ...
      <Modal open={modal} onClose={() => setModal(false)} keepMounted>
        <div
          className="mx-auto my-20 bg-white rounded-lg p-8 max-w-4xl w-11/12 overflow-auto"
          style={modalStyle}
        >
