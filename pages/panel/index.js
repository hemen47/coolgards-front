          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            {cards.map((card, index) => (
                <Link href={card.href} key={index}>
                  <div className={`rounded-xl shadow-sm border-l-4 ${card.color} p-5 transition-all duration-300 transform hover:scale-105 hover:shadow-md ${card.hoverColor} cursor-pointer`}>
