                    ...
                    {activeTab === 0 && analyticsData && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          <div className="bg-white p-4 rounded-lg shadow-sm">
                            <h3 className="text-lg font-medium text-gray-700 mb-4">Users (Last 30 Days)</h3>
                          ...
                          {/* Page Views Chart */}
                          <div className="bg-white p-4 rounded-lg shadow-sm">
                            <h3 className="text-lg font-medium text-gray-700 mb-4">Page Views (Last 30 Days)</h3>
                            <ResponsiveContainer width="100%" height={300}>
                          ...
                          <div className="bg-white p-4 rounded-lg shadow-sm">
                            <h3 className="text-lg font-medium text-gray-700 mb-4">Top Traffic Sources</h3>
                            <ResponsiveContainer width="100%" height={300}>
                    ...
                    {activeTab === 1 && analyticsData && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          <div className="bg-white p-4 rounded-lg shadow-sm col-span-2">
                            <h3 className="text-lg font-medium text-gray-700 mb-4">User Engagement Metrics</h3>
                            <p className="text-gray-500 mb-4">This section will display user engagement metrics like session duration, bounce rate, etc.</p>
                            <div className="h-64 flex items-center justify-center border border-dashed border-gray-300 rounded-lg">
                              <p className="text-gray-400">Additional user behavior charts will appear here</p>
                            </div>
                          </div>
                        </div>
                    )}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          {searchConsoleData && searchConsoleData.isAvailable ? (
                              <>
                                ...
                                <div className="bg-white p-4 rounded-lg shadow-sm col-span-2">
                                  <h3 className="text-lg font-medium text-gray-700 mb-4">Search Performance (Last 30 Days)</h3>
                                  <ResponsiveContainer width="100%" height={300}>
                                    {/* ... chart component ... */}
                                  </ResponsiveContainer>
                                </div>
                              ...
                              <div className="bg-white p-8 rounded-lg shadow-sm col-span-2">
                                <div className="text-center">
                                  ...
                                  <h3 className="text-xl font-medium text-gray-700 mb-2">Search Console Data Unavailable</h3>
                                  <p className="text-gray-500 mb-4">
                                    {searchConsoleData?.error || "To access Search Console data, you need to verify ownership of your site in Google Search Console and grant access to the service account."}
                                  </p>
                                  <a
