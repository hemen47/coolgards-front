...
import { Chip, FormControl, FormHelperText, InputAdornment, InputLabel, Tooltip } from "@mui/material";
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center">
            <Button
                ...
                className="mr-2"
                color={Object.values(searchQuery).some(v => v !== "" && v.length !== 0) ? "primary" : "default"}
            >
              Filters
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="w-full mb-6">
                ...
                <div className={`border rounded-md ${formErrors.content ? 'border-red-500' : 'border-gray-300'}`}>
                  <ReactQuill
        ...
        >
          <div className="flex flex-center flex-col p-6 items-center">
            ...
            <p className="text-gray-500 mb-6 text-center">
              Are you sure you want to delete <span className="font-medium text-gray-700">"{selectedRow?.title}"</span>?<br />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {selectedRow.tags && selectedRow.tags.map((tag, index) => (
                  ...
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="border border-gray-200 rounded-lg p-4">
                        ...
                        <p className="text-sm">{selectedRow.metaDescription || "No meta description"}</p>
                      </div>
                    </div>
                  </div>
                </div>
