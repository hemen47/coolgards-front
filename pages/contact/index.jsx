  ...
  return (
      <>
        <Head>
          ...
          <meta name="keywords" content="contact COOLGARDS, rehabilitation services contact, health products inquiry, medical support" />
        ...
        <div className="relative h-64 w-full bg-gradient-to-r from-blue-600 to-blue-800 md:h-80">
          ...
          <div className="container mx-auto flex h-full flex-col items-center justify-center px-4 text-center text-white">
            ...
            <p className="mt-4 max-w-2xl text-lg">We&#39;re here to help with all your rehabilitation and health product needs</p>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-2">
            <nav aria-label="Breadcrumb">
              <ol className="flex text-sm text-gray-600">
                ...
                <li aria-current="page" className="text-blue-600">Contact</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div className="w-full max-w-4xl rounded-lg bg-white p-8 shadow-lg">
              {sent ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="mb-6 text-lg text-gray-600">We have received your message successfully.</p>
            ...
            {[
              {
                ...
                answer: "Our office is open Monday through Friday, 9:00 AM to 5:00 PM CET. We're closed on weekends and public holidays."
              },
              {
              ...
              },
              {
                ...
                answer: "Yes, we ship our products globally. Shipping costs and delivery times vary by location."
              }
            ].map((faq, index) => (
