  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://coolgards.com/contact-image.jpg" />{' '}
        {/* Replace with actual image URL */}
        {/* Twitter Card tags  */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={pageTitle} />
        <meta name="twitter:description" content={pageDescription} />
        <meta name="twitter:image" content="https://coolgards.com/contact-image.jpg" />{' '}
        {/* Replace with actual image URL */}
        {/* Additional meta tags for better SEO  */}
        <meta
          name="keywords"
          content="contact COOLGARDS, rehabilitation services contact, health products inquiry"
        />
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className={styles.form} aria-label="Contact form">
              ...
              <p className={styles.privacyNote}>
                ...
                <Link href="/privacy-policy">Privacy Policy</Link>. We'll only use your information
