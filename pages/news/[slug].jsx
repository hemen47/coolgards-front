  ...
  return (
      <>
        <Head>
          ...
          <meta name="keywords" content={`${article.tags?.join(', ') || ''}, cold compression therapy, recovery, inflammation, rehabilitation`} />
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                      href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(canonicalUrl)}&title=${encodeURIComponent(article.title)}`}
                      target="_blank"
                      rel="noopener noreferrer"
          ...
          <div className="container mx-auto px-4 mt-16">
            <div className="max-w-3xl mx-auto bg-blue-50 rounded-xl p-8">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-center sm:text-left">{article.writerName}</h3>
                        ...
                        >
                          <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow h-full flex flex-col">
                            <div className="relative h-48 overflow-hidden">
                              <img
                                  src={post.imageUrl.startsWith('http') ? post.imageUrl : `${process.env.NEXT_PUBLIC_BASE_URL || 'https://coolgards.com'}${post.imageUrl}`}
                                  alt={post.title}
              ...
              <div className="md:flex items-center justify-between">
                <div className="mb-6 md:mb-0 md:w-2/3">
                  ...
                  <p className="text-blue-100">
                    Accelerate recovery, reduce pain and swelling with CoolGards' advanced cold compression therapy system.
                  </p>
                </div>
