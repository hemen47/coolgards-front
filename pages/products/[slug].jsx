  ...
  const sliderItemsGenerator = urls => {
    return urls.map((url, index) => {
      return {
        ...
        originalAlt: `${data?.data?.title} - Image ${
          index + 1
      ...
      <Head>
        ...
        <meta
          ...
          content={`${data?.data?.title}, cold compression therapy, ${data?.data?.tags.join(
            ', '
          )}, rehabilitation equipment, recovery device`}
        />
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="border-t border-b border-gray-200 py-4">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <Button variant="outlined" fullWidth className="py-3" href="/contact">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-blue-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        ...
                        from the injured area, promoting faster healing and recovery. [[1]](#__1)
                      </p>
                    </div>
                    <div className="bg-blue-50 p-6 rounded-lg">
                      <h3 className="text-lg font-medium text-blue-800 mb-2">
                      ...
                      <p className="text-gray-700">
                        ...
                        medication. The compression adds stability to the injured area. [[2]](#__2)
                      </p>
                    </div>
                    <div className="bg-blue-50 p-6 rounded-lg">
                      <h3 className="text-lg font-medium text-blue-800 mb-2">
