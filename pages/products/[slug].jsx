...
export default function Product({ data, error }) {
  ...
  useEffect(() => {
    if (data?.data) {
      const preloadImages = () => {
        const imagePromises = data.data.imageUrls.map(url => {
  ...
  const getMetaDescription = () => {
    ...
    const contentText = data?.data?.content ? data.data.content.replace(/<[^>]*>/g, ' ').trim() : '';
  ...
  const mainImageUrl = data.data.imageUrls && data.data.imageUrls.length > 0
  ...
  return (
      <>
        <Head>
          ...
          <meta property="og:image:alt" content={`${data.data.title} - CoolGards Cold Compression Therapy`} />
          <meta property="og:url" content={canonicalUrl} />
          <meta property="og:site_name" content="CoolGards" />
          <meta property="product:price:amount" content={data.data.price} />
          <meta property="product:price:currency" content="EUR" />
          <meta property="product:availability" content={data.data.status === 'available' ? 'in stock' : 'out of stock'} />
          ...
          <meta name="twitter:image:alt" content={`${data.data.title} - CoolGards Cold Compression Therapy`} />
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="border-t border-b border-gray-200 py-4">
                  ...
                  >
                    <meta itemProp="availability" content={data.data.status === 'available' ? 'https://schema.org/InStock' : 'https://schema.org/OutOfStock'} />
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="bg-blue-50 p-6 rounded-lg">
                          ...
                          <p className="text-gray-700">
                            We offer free standard shipping to all European countries. Delivery typically takes 3-5 business days.
                          </p>
                        </div>
                        <div className="bg-blue-50 p-6 rounded-lg">
                          <h3 className="text-lg font-medium text-blue-800 mb-2">
                          ...
                          <p className="text-gray-700">
                            We ship worldwide. International shipping costs and delivery times vary by location. Please contact us for specific details.
                          </p>
                        </div>
                        <div className="bg-blue-50 p-6 rounded-lg">
                          <h3 className="text-lg font-medium text-blue-800 mb-2">
                          ...
                          <p className="text-gray-700">
                            If you're not completely satisfied with your purchase, you can return it within 30 days for a full refund. The product must be in its original condition and packaging.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <section className="border-t border-gray-200 p-6 lg:p-8">
              ...
              <div className="space-y-4" itemScope itemType="https://schema.org/FAQPage">
                <div itemScope itemType="https://schema.org/Question" className="border rounded-lg overflow-hidden">
              ...
              <div className="md:flex items-center justify-between">
                <div className="mb-6 md:mb-0">
                  ...
                  <p className="text-blue-100">
                    Join thousands of satisfied customers who have improved their recovery with CoolGards.
                  </p>
                </div>
