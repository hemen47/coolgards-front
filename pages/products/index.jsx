...
export default function Products({ data, error }) {
    ...
    useEffect(() => {
        ...
        if (activeTags.length > 0) {
            result = result.filter(product =>
                product.tags && activeTags.every(tag => product.tags.includes(tag))
            );
        }
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Explore CoolGards' innovative cold compression therapy devices for post-injury rehabilitation, pain relief, and swelling reduction. FDA & CE approved medical equipment." />
                <meta name="keywords" content="cold compression therapy, cold therapy device, compression therapy, rehabilitation equipment, post-surgery recovery, sports injury treatment" />
                ...
                <meta property="og:description" content="Explore CoolGards' innovative cold compression therapy devices for rehabilitation and recovery." />
                ...
                <meta name="twitter:description" content="Explore CoolGards' innovative cold compression therapy devices for rehabilitation and recovery." />
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
                ...
                {/* Product grid */}
                <section id="product-grid" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8" aria-label="Product listing">
                    {isLoading ? (
                        ...
                        currentProducts.map((product) => (
                            ...
                            >
                                <Link href={`/products/${product.slug}`} className="block relative pb-[70%] overflow-hidden">
                                    <img
                                ...
                                <div className="p-4 flex flex-col flex-grow">
                                    ...
                                    <Link href={`/products/${product.slug}`} className="block">
                                        <h2 className="text-xl font-light text-gray-900 mb-2 hover:text-blue-600 transition-colors" itemProp="name">
                                            {product.title}
                                        </h2>
                                    </Link>

                                    <p className="text-3xl font-light text-gray-900 mb-4" itemProp="offers" itemScope itemType="https://schema.org/Offer">
                ...
                <section className="bg-gray-50 rounded-xl p-8 mt-12">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <p className="text-gray-600">
                                FDA & CE approved equipment for home, clinical, and athletic use with proven results.
                            </p>
                        </div>
                    </div>
                </section>
