...
export default function About() {
  ...
  const pageDescription = "COOLGARD provides comprehensive rehabilitation treatment services and premium products for athletes, physiotherapists, and health-conscious individuals.";
  ...
  const structuredData = {
    ...
    "description": "COOLGARD provides comprehensive rehabilitation treatment services and premium products for athletes, physiotherapists, and health-conscious individuals.",
    "sameAs": [
  ...
  return (
      <>
        <Head>
          ...
          <meta property="og:image" content="https://coolgards.com/about-image.jpg" /> {/* Replace with actual image URL */}

          {/* Twitter Card tags  */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content={pageTitle} />
          <meta name="twitter:description" content={pageDescription} />
          <meta name="twitter:image" content="https://coolgards.com/about-image.jpg" /> {/* Replace with actual image URL */}

          {/* Additional meta tags for better SEO  */}
          <meta name="keywords" content="rehabilitation, physiotherapy, athletes, health products, COOLGARDS" />
          ...
          <div className={styles.about}>
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
              ...
              <div className="mt-8 max-w-3xl text-center mx-auto">
                <section aria-labelledby="quality-policy"> {/* Semantic HTML  */}
                  <h2 id="quality-policy" className="text-2xl font-bold mb-4 text-gray-800">QUALITY POLICY</h2>
              ...
              <div className="mt-8 max-w-3xl text-center mx-auto">
                <section aria-labelledby="our-values">
                  <h2 id="our-values" className="text-2xl font-bold mb-4 text-gray-800">OUR VALUES</h2>
