...
export default function Store({ data, error }) {
  ...
  return (
    <div className={styles.container}>
      {/*<h1 content={styles.title}>About Us</h1>*/}
      <div>
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            ...
            <p className="mt-1 text-gray-600 dark:text-gray-400">Our team</p>
          </div>
          <div className="flex">
            {/*start*/}
            <div className="m-[5rem] w-[450px] flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
