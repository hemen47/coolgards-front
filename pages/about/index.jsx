  ...
  return (
      <>
        <Head>
          ...
          <meta name="keywords" content="rehabilitation, physiotherapy, athletes, health products, COOLGARDS, Lund, Sweden" />
        ...
        <div className="relative h-64 w-full bg-gradient-to-r from-blue-600 to-blue-800 md:h-80">
          ...
          <div className="container mx-auto flex h-full flex-col items-center justify-center px-4 text-center text-white">
            <h1 className="text-4xl font-bold md:text-5xl lg:text-6xl">About <span className="text-blue-200">COOLGARDS</span></h1>
            <p className="mt-4 max-w-2xl text-lg">Rehabilitation solutions for health professionals and athletes</p>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 py-2">
            <nav aria-label="Breadcrumb">
              <ol className="flex text-sm text-gray-600">
                ...
                <li aria-current="page" className="text-blue-600">About</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="mb-20">
            <div className="grid gap-12 md:grid-cols-2 items-center">
              ...
              <div className="order-1 md:order-2">
                <div className="mb-4 inline-block rounded-full bg-blue-100 px-4 py-1 text-sm font-medium text-blue-800">Our Story</div>
                <h2 className="mb-6 text-3xl font-bold text-gray-800 md:text-4xl">Pioneering Rehabilitation Solutions</h2>
          ...
          <div className="mb-20 bg-gray-50 p-8 rounded-xl shadow-sm">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4 inline-block rounded-full bg-blue-100 px-4 py-1 text-sm font-medium text-blue-800">Our Commitment</div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <div className="mb-4 inline-block rounded-full bg-blue-100 px-4 py-1 text-sm font-medium text-blue-800">What Drives Us</div>
              ...
              {[
                {
                  ...
                  description: "We prioritize understanding and meeting the unique needs of each customer."
                },
                {
                  icon: (
                      <svg className="h-8 w-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  title: "Innovation",
                  description: "Continuous development of new solutions to stay ahead in the industry."
                },
                {
                  icon: (
                      <svg className="h-8 w-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                },
                {
                  ...
                  <div key={index} className="rounded-lg bg-white p-6 shadow-md transition-transform hover:transform hover:-translate-y-1 hover:shadow-lg">
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <div className="mb-4 inline-block rounded-full bg-blue-100 px-4 py-1 text-sm font-medium text-blue-800">Get In Touch</div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg transform transition-transform hover:-translate-y-1">
                <h3 className="text-2xl font-bold mb-6 text-gray-800 border-b border-gray-200 pb-3">Contact Information</h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="mailto:info@coolgards.com" className="hover:text-blue-600 transition-colors">
                          info@coolgards.com
                        </a>
                      </p>
                    </div>
                      ...
                      {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                          ...
                          >
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                              ...
                              {social === 'twitter' && <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.054 10.054 0 01-3.127 1.184 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />}
          ...
          <div className="mb-20 bg-gray-50 rounded-2xl p-10">
            <div className="text-center mb-12">
              <div className="mb-4 inline-block rounded-full bg-blue-100 px-4 py-1 text-sm font-medium text-blue-800">What People Say</div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  quote: "COOLGARDS products have significantly improved my recovery time after sports injuries. Their rehabilitation solutions are top-notch.",
                  author: "Erik Johansson",
                  title: "Professional Athlete",
                  image: "/images/testimonials/testimonial-1.jpg"
                },
                {
                  quote: "As a physiotherapist, I recommend COOLGARDS products to all my clients. The quality and effectiveness are unmatched in the industry.",
                  author: "Maria Andersson",
                  title: "Senior Physiotherapist",
                  image: "/images/testimonials/testimonial-2.jpg"
                },
                {
                  quote: "The customer service at COOLGARDS is exceptional. They provided personalized recommendations for my rehabilitation needs.",
