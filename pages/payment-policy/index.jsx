        ...
        <div className="container mx-auto px-4 py-12">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <section className="mb-10">
                ...
                <div className="mb-8 rounded-lg bg-blue-50 p-6">
                  ...
                  <p className="mt-4 text-gray-700">
                    Payment for your purchases is made by credit card through our secure online payment
                    system. We accept all major credit cards, as well as payments made through PayPal.
                    Your credit card information is not processed through or stored on coolgards.com servers,
                    and no information is ever released to a third party.
                  </p>
                </div>

                <div className="mb-8">
                  <h3 className="mb-4 text-xl font-semibold text-gray-800">Accepted Payment Methods</h3>
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                    {paymentMethods.map((method) => (
                        <div key={method.name} className="flex flex-col items-center rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                          ...
                          <span className="text-center text-sm font-medium text-gray-800">{method.name}</span>
                        </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-700">
                        All transactions are encrypted using industry-standard SSL technology to ensure
                ...
                <div className="mb-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-700">
                        Our payment processing complies with PCI DSS (Payment Card Industry Data Security Standard)
              ...
              <section className="mb-10">
                ...
                <div className="mb-6 rounded-lg bg-gray-50 p-6">
                  ...
                  <ol className="ml-6 list-decimal space-y-4 text-gray-700">
                    <li>
                      <strong>Immediate Processing:</strong> When you complete a purchase, your card will be charged immediately.
                    </li>
                    <li>
                      <strong>Order Confirmation:</strong> You will receive an email confirmation with your order details and payment receipt.
                    </li>
                    <li>
                      <strong>Subscription Billing (if applicable):</strong> For subscription-based services, your card will be
                      automatically billed according to your selected payment schedule until you cancel your subscription.
                    </li>
                    <li>
                      <strong>Secure Transaction:</strong> All payment information is encrypted and processed securely.
                    </li>
                  </ol>
                </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-yellow-700">
                        <p>
                          Please ensure your payment method has sufficient funds before placing an order.
                          Failed payment attempts may result in order processing delays.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <section className="mb-10">
                <h2 className="mb-6 text-2xl font-bold text-gray-800">Currency and International Payments</h2>
                <p className="mb-6 text-gray-700">
                  All prices on our website are displayed in Euros (€). If you&#39;re paying with a card issued in
                  a different currency, your bank will convert the amount using their exchange rate, which may
                  include additional fees. PayPal users may have the option to choose their preferred currency
                  for the transaction.
                </p>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                    ...
                    <p className="text-gray-700">
                      Currency exchange rates are determined by your payment provider and may fluctuate daily.
                    </p>
                  </div>
                  <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                    <h3 className="mb-2 text-lg font-medium text-gray-800">International Fees</h3>
                    <p className="text-gray-700">
                      Some banks may charge international transaction fees for purchases made from foreign merchants.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="space-y-6">
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-lg font-bold text-gray-800">Is it safe to use my credit card on your website?</h3>
                  <p className="text-gray-700">
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-lg font-bold text-gray-800">When will my card be charged?</h3>
                  <p className="text-gray-700">
                    Your card will be charged immediately when you complete your purchase. You&#39;ll receive
                    an email confirmation with your order details and payment receipt.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    If your payment fails, you&#39;ll receive an error message during checkout. Please verify your
                    payment details and try again, or use an alternative payment method. If problems persist,
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Yes, PayPal is a secure payment platform that allows you to pay without sharing your
                    financial information. PayPal also offers buyer protection policies for eligible purchases.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Contact Information */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-2xl font-bold text-gray-800">Payment Questions or Concerns?</h2>

              <div className="rounded-lg bg-gray-50 p-6">
                <p className="mb-4 text-gray-700">
                  If you have any questions about our payment policy or experience any issues with your transaction,
                  please don&#39;t hesitate to contact us:
                </p>

                <div className="grid gap-4 md:grid-cols-3">
                  <div className="rounded-lg border border-gray-200 bg-white p-4 text-center">
                    <svg className="mx-auto mb-2 h-8 w-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
