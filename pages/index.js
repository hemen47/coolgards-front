            ...
            <div className="relative container mx-auto px-4">
              ...
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                  The CoolGards system combines precise cold therapy with targeted compression to accelerate healing and reduce pain after surgery or injury.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Rapid Pain Relief</h3>
                  <p className="text-gray-700 mb-4">
                    Controlled cold therapy reduces nerve conduction velocity and inflammatory response, providing immediate pain relief after injury or surgery.
                  </p>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Targeted Compression</h3>
                  <p className="text-gray-700 mb-4">
                    Precision-controlled compression reduces swelling by limiting fluid build-up in the injured area while improving blood circulation to promote healing.
                  </p>
                  <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent my-4"></div>
                  <p className="text-blue-600 font-medium">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Accelerated Recovery</h3>
                  <p className="text-gray-700 mb-4">
                    The synergistic effect of cold and compression therapy significantly reduces recovery time, allowing patients to return to normal activities faster.
                  </p>
                  <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent my-4"></div>
                  <p className="text-blue-600 font-medium">
                ...
                <div className="flex flex-col md:flex-row items-center">
                  <div className="md:w-2/3 md:pr-8">
                    ...
                    <p className="text-gray-700 mb-6">
                      The CoolGards system was developed to be a safe, effective, and affordable medical device that can be deployed in almost any setting. Whether in a hospital, physical therapy clinic, athletic facility, or at home, our system provides professional-grade cold compression therapy with intuitive controls and minimal setup time.
                    </p>
