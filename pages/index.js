...
export default function Home() {
  ...
  const applications = [
    {
      ...
      description: "Ideal for treating injuries from athletic activities like sprains, strains, and contusions",
  ...
  const faqs = [
    {
      ...
      answer: "Most treatment protocols recommend 20-30 minute sessions, 3-5 times daily. Always follow your healthcare provider's specific instructions for your condition."
    },
    {
      question: "Is the CoolGards system covered by insurance?",
      answer: "Many insurance plans cover cold compression therapy devices with a prescription. We recommend checking with your insurance provider about coverage options."
    },
    {
      question: "How does CoolGards compare to ice packs?",
      answer: "Unlike traditional ice packs, CoolGards provides consistent temperature control and adds therapeutic compression. This combination delivers more effective treatment and eliminates the mess and inconvenience of melting ice."
    },
    {
      question: "Can I travel with my CoolGards system?",
      answer: "Yes! The CoolGards system is designed to be portable and comes with a carrying case for easy transport, allowing you to continue therapy while traveling."
    },
  ];
  ...
  const productStructuredData = {
    ...
    "description": "Medical device for cold and compression therapy to treat injuries, reduce inflammation and accelerate recovery.",
  ...
  return (
      <>
        <Head>
          ...
          <meta name="description" content="CoolGards provides medical-grade cold compression therapy systems for injury recovery, post-operative rehabilitation, and pain management. FDA & CE approved." />
          <meta name="keywords" content="cold compression therapy, cold therapy, compression therapy, rehabilitation, injury recovery, post-surgery recovery, pain management, swelling reduction, sports medicine" />
          <meta property="og:title" content="CoolGards | Cold Compression Therapy Systems" />
          <meta property="og:description" content="Medical-grade cold compression therapy systems for injury recovery, rehabilitation, and pain management. FDA & CE approved." />
        ...
        <main>
          ...
          <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Benefits of CoolGards Therapy</h2>
                ...
                <div className={styles.details}>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <span>Intermittent cold compression accelerates the healing process and reduces pain and swelling</span>
                    </li>
                    <li className="flex items-start">
                      <FaCheck className="text-blue-600 mt-1 mr-2 flex-shrink-0" />
              ...
              <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
                ...
                <div className="max-w-3xl text-center mx-auto">
                  <p className="text-lg text-gray-400">
                    Cold compression therapy works by constricting the blood vessels, which in turn reduces swelling and inflammation. Calms muscle spasms, minimizes bruising and soothes nerve endings, encouraging quick and effective healing for a variety of muscle, tendon and ligament injuries.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-12">
                  <div className="bg-slate-800 rounded-xl p-6 text-center">
                    ...
                    <p className="text-gray-300">Cold therapy causes blood vessels to constrict, limiting blood flow to the injured area and reducing swelling.</p>
                  </div>
                  <div className="bg-slate-800 rounded-xl p-6 text-center">
                    <h3 className="text-blue-400 font-bold text-xl mb-3">2. Controlled Pressure</h3>
                    <p className="text-gray-300">Compression provides mechanical pressure to limit fluid buildup while supporting the injured area.</p>
                  </div>
                  <div className="bg-slate-800 rounded-xl p-6 text-center">
                    <h3 className="text-blue-400 font-bold text-xl mb-3">3. Pain Reduction</h3>
                    <p className="text-gray-300">Cold temperature numbs nerve endings, significantly reducing pain signals to the brain.</p>
                  </div>
                </div>
          ...
          <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
              ...
              <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">CoolGards therapy systems are versatile and can be used in various settings for different conditions.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-xl shadow">
                  ...
                  <blockquote className="mb-4 text-gray-700">
                    &quot;As a physical therapist, I&apos;ve used many cold therapy systems. CoolGards stands out for its consistent temperature control and ease of use. My patients report faster recovery times.&quot;
                  </blockquote>
                ...
                <div className="bg-white p-6 rounded-xl shadow">
                  ...
                  <blockquote className="mb-4 text-gray-700">
                    &quot;After my ACL reconstruction, the CoolGards system was a game-changer for my home recovery. Much better than ice packs that constantly need replacing.&quot;
                  </blockquote>
                ...
                <div className="bg-white p-6 rounded-xl shadow">
                  ...
                  <blockquote className="mb-4 text-gray-700">
                    &quot;Our sports medicine department equipped all training rooms with CoolGards systems. The portability and effectiveness have made them essential tools for our trainers.&quot;
                  </blockquote>
          ...
          <section id="faq" className="py-16 bg-white">
            <div className="container mx-auto px-4">
              ...
              <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">Find answers to common questions about CoolGards cold compression therapy systems.</p>
            ...
            <div className="container mx-auto">
              <div className={`${styles.fdaSection} flex-col md:flex-row`}>
                <div className="max-w-md text-center md:text-left mb-6 md:mb-0">
                  ...
                  <p className="text-lg">All CoolGards devices are fully compliant with CE and FDA regulatory approval, ensuring the highest standards of safety and efficacy for medical use.</p>
                </div>
                <div className="flex">
                  <Image
                      src="/ce.webp"
          ...
          <section className="py-16 bg-gradient-to-r from-blue-600 to-violet-600 text-white">
            <div className="container mx-auto px-4 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Experience the Power of Cold Compression Therapy?</h2>
              <p className="text-xl max-w-2xl mx-auto mb-8">Join thousands of healthcare professionals, athletes, and patients who trust CoolGards for their recovery needs.</p>
            ...
            <div className="container mx-auto px-4">
              <div className="flex flex-wrap justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">Our team is ready to assist you with any inquiries about our products.</p>
