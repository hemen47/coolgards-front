...
export default function PrivacyPolicy() {
  ...
  const pageDescription = 'Learn about how COOLGARDS collects, uses, and protects your personal information. Our privacy policy explains your rights and our practices regarding your data.';
  ...
  return (
      <>
        <Head>
          ...
          <meta name="keywords" content="COOLGARDS privacy policy, data protection, personal information, privacy rights, cookies policy" />
          ...
          <div className="mx-auto max-w-4xl">
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-8 border-b border-gray-200 pb-6">
                ...
                <p className="text-gray-600">
                  This Privacy Policy describes how COOLGARDS collects, uses, and shares your personal information when you visit our website or make a purchase.
                </p>
              </div>

              <section className="mb-8">
                <h2 className="mb-4 text-2xl font-bold text-gray-800">WHAT DO WE DO WITH YOUR INFORMATION?</h2>
                <div className="rounded-lg bg-blue-50 p-6">
                  <p className="text-gray-700">
                    When you purchase something from our store, as part of the buying and selling process, we collect the personal information you give us such as your name, address, phone number and email address. With your permission, we may send you emails about our store, new products and other updates.
                  </p>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="mb-4 text-2xl font-bold text-gray-800">YOUR INFORMATION IS <span className="text-blue-600">NOT</span> DISCLOSED TO OUTSIDE PARTIES</h2>
                <p className="mb-4 text-gray-700">
                  We do not sell your Personal Information to third parties for their marketing or any other purposes. We may provide or make your Personal Information available to:
                </p>
                <ul className="ml-6 list-disc space-y-3 text-gray-700">
                  <li>
                    Our employees, the staff in order to enable them to assist us to interact with you via our Platforms for the marketing, ordering or delivery of goods.
                  </li>
                  <li>
              ...
              <section className="mb-8">
                <h2 className="mb-4 text-2xl font-bold text-gray-800">OPT-OUT FROM DIRECT MARKETING</h2>
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
                  <p className="text-gray-700">
                    You have the right to request us not to contact you for purposes of direct marketing by any form of electronic communication, by contacting us at{' '}
              ...
              <section className="mb-8">
                <h2 className="mb-4 text-2xl font-bold text-gray-800">CHANGES TO THIS PRIVACY POLICY</h2>
                <p className="text-gray-700">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-bold text-gray-800">QUESTIONS AND CONTACT INFORMATION</h2>
                <div className="rounded-lg bg-blue-50 p-6">
                  <p className="text-gray-700">
            ...
            <div className="mb-12 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg bg-white p-6 shadow-md">
                ...
                <p className="text-gray-700">
                  Depending on your location, you may have certain rights regarding your personal data, such as the right to access, correct, or delete your information.
                </p>
              </div>
              <div className="rounded-lg bg-white p-6 shadow-md">
