...
export default function ShipmentPolicy() {
  ...
  const pageDescription = 'Learn about COOLGARDS shipping methods, delivery timeframes, international shipping options, and our free shipping policy for European customers.';
  ...
  return (
      <>
        <Head>
          ...
          <meta name="keywords" content="COOLGARDS shipping, free shipping Europe, international shipping, shipping timeframes" />
          ...
          <div className="container mx-auto px-4 py-2">
            <nav aria-label="Breadcrumb">
              <ol className="flex text-sm text-gray-600">
                ...
                <li aria-current="page" className="text-blue-600">Shipping Policy</li>
              </ol>
            </nav>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-4xl">
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <section className="mb-10">
                ...
                <div className="mb-6 rounded-lg bg-blue-50 p-6">
                  <div className="flex items-center">
                    ...
                    <p className="text-lg font-medium text-blue-800">Free Shipping Throughout Sweden</p>
                  </div>
                  <p className="mt-4 text-gray-700">
                    We provide complimentary shipping services to all customers within Sweden. Your order will be carefully
                    packaged and shipped via our partners for reliable delivery.
                  </p>
                </div>

                <p className="mb-6 text-lg text-gray-700">
                  All orders are promptly processed within one business day, excluding weekends and holidays.
                  The estimated shipping time for deliveries is approximately 2 to 3 working days. Please note
                  that while we strive to meet these timelines, we have limited control over the actual delivery process.
                </p>

                <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-3 text-lg font-semibold text-gray-800">Order Tracking</h3>
                  <p className="text-gray-700">
                    To help you stay updated on your order&#39;s progress, a confirmation email containing tracking
                    information will be automatically sent within 24 hours of shipment.
                  </p>
                </div>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="mb-6 text-lg text-gray-700">
                  For international shipments outside of Europe, it&#39;s important to mention that customs fees,
                  tariffs, and taxes may apply and vary depending on the destination country. These charges are
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-yellow-700">
                        <p>
                          Please be aware that international shipments may be subject to:
                        </p>
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border border-gray-200 bg-white p-4">
                    <button className="flex w-full items-center justify-between text-left">
                      <span className="font-medium text-gray-800">What happens if my package is lost?</span>
                    </button>
                    <div className="mt-2 text-gray-700">
                      <p>
                        In the rare event that your package is lost during transit, please contact us at {companyInfo.email}
                        with your order number. We&#39;ll work with our shipping partner to locate your package or process a
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-4">
                    <button className="flex w-full items-center justify-between text-left">
                      <span className="font-medium text-gray-800">Can I change my shipping address after placing an order?</span>
                    </button>
                    <div className="mt-2 text-gray-700">
                      <p>
                        Address changes must be requested within 2 hours of placing your order. Please contact us immediately
                        at {companyInfo.email} with your order number and the new shipping address.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-4">
                    ...
                    <div className="mt-2 text-gray-700">
                      <p>
                        Yes, we can ship to P.O. boxes within Europe. For international orders, we recommend using a physical
                        address to ensure smoother customs processing.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {/* Contact Information */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-2xl font-bold text-gray-800">Shipping Questions or Concerns?</h2>

              <div className="rounded-lg bg-gray-50 p-6">
                <p className="mb-4 text-gray-700">
                  If you have any questions about our shipping policy or need assistance tracking your order,
