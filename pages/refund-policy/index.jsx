  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="COOLGARDS offers a 7-day return policy on trading cards and collectibles. Learn about our fair refund process, exchange options, and return conditions."
        />
        <meta
          name="keywords"
          content="trading card returns, collectible card refunds, COOLGARDS return policy, trading card exchange policy, TCG refund policy"
        />
      ...
      <div className={styles.container}>
        ...
        <nav aria-label="Breadcrumb" className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          <ol className="flex text-sm text-gray-500">
            ...
            <li className="flex items-center">
              <Link href="/customer-service" className="hover:text-blue-600">
                Customer Service
              </Link>
              <svg className="mx-2 h-4 w-4" fill="currentColor" viewBox="0 0 16 16">
                <path
            ...
            <div className={styles.contentContainer}>
              <section id="overview">
                ...
                <p className="mb-6 text-lg">
                  ...
                  quality trading cards and collectibles, ensuring excellent value for your
                  investment. However, if you find yourself unsatisfied with your order or product
                  for any reason, we kindly request that you notify us of your intention to return
                  it within <strong>7 days</strong> of receiving your delivery. Your satisfaction is
                  our top priority, and we will do our best to address any concerns you may have.
                </p>
              </section>

              <section id="legal-guarantees">
                <h2 className="text-2xl font-bold mb-4">
                  Legal Guarantees for Trading Card Purchases
                </h2>
                <p className="mb-6 text-lg">
                  All our collectible trading cards and products benefit from the legal guarantee of
                  conformity and the guarantee against hidden defects. In the event of
                  non-compliance of a product sold, it may be returned, exchanged or refunded. All
                  complaints, requests for exchange or refund must be made by email to
                  <a
                    href="mailto:returns@coolgards.com"
                    className="text-blue-600 hover:underline ml-1"
                  >
                    returns@coolgards.com
                  </a>{' '}
                  within
              ...
              <section id="return-condition">
                ...
                <p className="mb-6 text-lg">
                  The trading cards and collectibles must be returned to us in the state in which
                  you received them with all the elements (accessories, packaging, instructions,
                  protective sleeves, etc.). For sealed products, the original packaging must remain
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      Individual cards must be returned in the same protective sleeves or cases
                    </li>
              ...
              <section id="return-costs">
                ...
                <p className="mb-6 text-lg">
                  Note that the return costs are your responsibility whatever the reason. We
                  recommend using tracked shipping methods to ensure your valuable collectibles can
                  be monitored throughout the return process. Once we receive and verify your
                  return, refunds will be processed within 3-5 business days.
                </p>
              </section>
              ...
              <section id="non-returnable-items">
                ...
                <p className="mb-6 text-lg">The following items cannot be returned or exchanged:</p>
              ...
              <section id="contact">
                ...
                <p className="mb-6 text-lg">
                  If you have any questions about returning trading cards or our refund policy,
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <p>
                    <strong>Email:</strong>{' '}
                    <a
                      href="mailto:support@coolgards.com"
                      className="text-blue-600 hover:underline"
                    >
                      support@coolgards.com
                    </a>
                  </p>
                  <p>
                    <strong>Phone:</strong>{' '}
            ...
            <section className="mt-12 border-t pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Link href="/grading-policy" className="p-4 border rounded hover:bg-gray-50">
                  ...
                  <p className="text-sm text-gray-600">
                    Understand how we grade and authenticate collectible trading cards.
                  </p>
                </Link>
            ...
            <section className="mt-12 border-t pt-6" id="faq">
              ...
              <div className="space-y-4">
                <div className="border-b pb-4">
                  ...
                  <p>
                    Email returns@coolgards.com within 7 days of delivery with your order number and
                    reason for return. Our team will provide you with return instructions and a
                ...
                <div className="border-b pb-4">
                  ...
                  <p>
                    No, once a sealed product like a booster pack has been opened, it cannot be
                    returned due to the nature of trading card products.
                  </p>
                </div>
                ...
                <div className="border-b pb-4">
                  ...
                  <p>
                    ...
                    days. If approved, your refund will be processed within 3-5 business days. The
                    time it takes to appear in your account depends on your payment method and
                ...
                <div className="border-b pb-4">
                  ...
                  <p>
                    Yes, we offer store credit with a 10% bonus value compared to cash refunds. This
