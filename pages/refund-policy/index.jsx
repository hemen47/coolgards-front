          ...
          <div className="container mx-auto px-4 py-2">
            <nav aria-label="Breadcrumb">
              <ol className="flex text-sm text-gray-600">
                ...
                <li aria-current="page" className="text-blue-600">Refund Policy</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <section id="overview" className="mb-10">
                <div className="mb-6 border-b border-gray-200 pb-6">
                  ...
                  <p className="text-lg text-gray-700">
                    At <strong>COOLGARDS</strong>, we are committed to providing you with the highest quality products,
                    ensuring excellent value for your investment. However, if you find yourself unsatisfied with your
                    order or product for any reason, we kindly request that you notify us of your intention to return
                    it within <strong>7 days</strong> of receiving your delivery. Your satisfaction is our top priority,
                    and we will do our best to address any concerns you may have.
                  </p>
                </div>
              </section>

              <section id="legal-guarantees" className="mb-10">
                <h2 className="mb-4 text-2xl font-bold text-gray-800">Legal Guarantees for Purchases</h2>
                <div className="rounded-lg bg-blue-50 p-6">
                  <p className="text-gray-700">
                    All our products benefit from the legal guarantee of conformity and the guarantee against hidden defects.
                    In the event of non-compliance of a product sold, it may be returned, exchanged or refunded. All complaints,
                    requests for exchange or refund must be made by email to{' '}
              ...
              <section id="return-condition" className="mb-10">
                ...
                <p className="mb-6 text-gray-700">
                  The products must be returned to us in the state in which you received them with all the elements
                  (accessories, packaging, instructions, etc.). For sealed products, the original packaging must remain
                  unopened and undamaged to be eligible for a full refund.
                </p>

                <div className="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-6">
                  <h3 className="mb-3 text-xl font-semibold text-gray-800">Special Return Conditions:</h3>
              ...
              <section id="return-costs" className="mb-10">
                ...
                <div className="flex items-start rounded-lg border-l-4 border-yellow-400 bg-yellow-50 p-4">
                  ...
                  <p className="text-gray-700">
                    <strong>Important:</strong> Return shipping costs are your responsibility regardless of the reason for return.
                    We recommend using tracked shipping methods to ensure your valuable items can be monitored throughout the
                    return process. Once we receive and verify your return, refunds will be processed within 3-5 business days.
                  </p>
                </div>
              </section>
              ...
              <section id="exchange-options" className="mb-10">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                    ...
                    <p className="text-gray-700">
                      We offer store credit with a 5% bonus value compared to cash refunds. This credit can be used
                      on any future purchase and does not expire.
                    </p>
                  </div>
                  <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                    <h3 className="mb-2 text-lg font-semibold text-gray-800">Direct Exchange</h3>
                    <p className="text-gray-700">
                      We can exchange your product for an identical replacement if the original was defective or damaged.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section id="non-returnable-items" className="mb-10">
                ...
                <p className="mb-4 text-gray-700">The following items cannot be returned or exchanged:</p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600">
                          Once we receive your return, we&#39;ll inspect the items within 2 business days. If approved, your refund
                          will be processed within 3-5 business days. The time it takes to appear in your account depends on
                ...
                <div className="rounded-lg bg-gray-50 p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <svg className="mr-2 mt-1 h-5 w-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg" id="faq">
              ...
              <div className="space-y-6">
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-lg font-bold text-gray-800">How do I initiate a return?</h3>
                  <p className="text-gray-700">
                    Email {companyInfo.email} within 7 days of delivery with your order number and reason for return.
                    Our team will provide you with return instructions and a return authorization number.
                  </p>
                </div>

                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-lg font-bold text-gray-800">Can I return opened products?</h3>
                  <p className="text-gray-700">
                    No, once a sealed product has been opened, it cannot be returned due to the nature of our products.
                  </p>
                </div>

                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-lg font-bold text-gray-800">How long does it take to process my refund?</h3>
                  <p className="text-gray-700">
                    Once we receive your return, we&#39;ll inspect the items within 2 business days. If approved, your refund
                    will be processed within 3-5 business days. The time it takes to appear in your account depends on
                    your payment method and financial institution.
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-lg font-bold text-gray-800">Do you offer store credit instead of refunds?</h3>
                  <p className="text-gray-700">
                    Yes, we offer store credit with a 5% bonus value compared to cash refunds. This credit can be used
                    on any future purchase and does not expire.
                  </p>
                </div>

                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-lg font-bold text-gray-800">What if my item arrives damaged?</h3>
                  <p className="text-gray-700">
                    If your item arrives damaged, please take photos of the damage and contact us at {companyInfo.email}
                    within 48 hours of receiving your package. We&#39;ll work with you to resolve the issue promptly.
                  </p>
                </div>
              </div>
            </div>
