...
export default function PanelSideBar() {
    ...
    return (
        ...
        <nav className={styles.menu}>
            ...
            <Link style={router.pathname === '/panel/users' ? {backgroundColor: "#032b5c"} : {}} href='/panel/users'
                  className='flex justify-start items-center'><PeopleAltOutlinedIcon sx={{marginRight: ".5rem"}}/>Users</Link>
            <Link style={router.pathname === '/panel/posts' ? {backgroundColor: "#032b5c"} : {}} href='/panel/posts'
